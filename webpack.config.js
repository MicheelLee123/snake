...
module.exports = [
  {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        { from: './src/css/snake.css', to: './dist/css/snake.css' },
        { from: './src/images/play@2x.png', to: './dist/images/play@2x.png' },
        { from: './src/images/pause@2x.png', to: './dist/images/pause@2x.png' },
        { from: './src/images/switch@2x.png', to: './dist/images/switch@2x.png' },
      ]),
    ],
    devServer: {
      static: './dist/',
      open: openBrowser,
      open: './dist/snake.html',
    },
    watch: true,
  },
];
